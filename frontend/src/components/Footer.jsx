    ...
    return (
        <div style={{padding: "12px 0px", backgroundColor : "rgb(232, 227, 227)", textAlign: 'center', position:'fixed', width: '100%',height : '85px', bottom : '0', left: '0', right: '0', zIndex : '999'}}>
            ...
            <div className="text-center">
                    <h5>
                        Made with ❤️ by <a href="" style={{textDecoration : "none", color: "red"}}>Pavikkaran</a>
                    </h5>
            </div> 

            <div className="text-center pt-1">
                <a href="https://www.linkedin.com/in/pavikkaran/" target="_blank" rel="noreferrer">
                ...
                <a href="https://github.com/Pavikkaran-p/" target="_blank" rel="noreferrer">
